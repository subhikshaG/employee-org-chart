...
export function makeServer({ environment = 'development' } = {}) {
  let server = new Server({
    ...
    seeds(server) {
      server.create('employee', { id: 'n3', name: 'Bob Marley', designation: 'SDE 1', team: 'Engineering', managerId: 'n4' });
      ...
      server.create('employee', { id: 'n20', name: 'Erica Thompson Edward', designation: 'Chief Business officer', team: 'Finance', managerId: 'n2' });
